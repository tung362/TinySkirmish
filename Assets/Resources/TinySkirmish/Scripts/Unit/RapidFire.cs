...
public class RapidFire : NetworkBehaviour
{
    public GameObject Projectile;
    public float Range = 2;
    public float Spread = 45;
    ...
    void Update()
    {
        ...
        if (target != null)
        {
            ...
            if (FireTimer >= FireDelay)
            {
                ...
                spawnedUnit.GetComponent<RapidProjectile>().Direction = Quaternion.Euler(0, Random.Range(Spread, -Spread), 0) * (target.transform.position - transform.position).normalized;

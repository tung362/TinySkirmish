...
public class PlayerControlPanel : NetworkBehaviour
{
    ...
    public GameObject TransformSyncManagerPrefab;
    ...
    void InitializeServer()
    {
        ...
        GameObject spawnedTransformSyncManager = Instantiate(TransformSyncManagerPrefab, Vector3.zero, Quaternion.identity) as GameObject;
        NetworkServer.Spawn(spawnedTransformSyncManager);
        ...
        //spawnedCommandManager.GetComponent<CommandManager>().TransformSyncManagerObject = spawnedTransformSyncManager;
